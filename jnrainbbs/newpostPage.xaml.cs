...
namespace jnrainbbs
{
    ...
    public sealed partial class newpostPage : Page
    {
        ...
        public myParam2 myparam2 { get; set; }
        public static string convalue { get; set; }
        ...
        {
            e.PageState["txtContents"] = this.ContentTextBox.Text;
        }
        ...
        private void addEmoji_Click(object sender, RoutedEventArgs e)
        {
            ...
            convalue = "";
            Frame.Navigate(typeof(chooseEmojiPage));
        }
